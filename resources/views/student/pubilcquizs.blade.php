...
{{$message}}</div>
 ...
 @endif
 <div class="m-sm-auto row justify-content-center">
    <div class="search-flex col-xl-9 d-flex justify-content-between">
        <div class="d-flex">
            <form action="{{route('public.quizs.index')}}" method="get" class="d-flex justify-content-between">
        ...
        <div class="social-links mt-2" style=" flex-shrink: 0;">
            ...
            <div style="position: relative">
                <div style="position: absolute;z-index:5;bottom:0;right:0;">
                    ...
                    <a style="border: 1px solid #0000004e; border-radius: 10px;" href="{{route('student.addtofav',$item)}}" class="text-black p-1 mx-1" >
                        ...
                        <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
                          <div class="modal-dialog">
                            ...
                            <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item border-bottom" href="#">new collection</a></li>
                                @php
