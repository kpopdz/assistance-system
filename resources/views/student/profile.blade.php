        ...
        //    wrapper.classList.add("active");
         ...
         backImg.style.display='none';
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      <input  type="text" class="form-control" id="fullName" value="{{$student->firstname}}" name="firstname" required>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Last Name</label>
                    <div class="col-md-8 col-lg-9">
                      <input type="text" class="form-control" id="fullName" value="{{$student->lastname}}" name="lastname" required>
                    </div>
                  </div>
