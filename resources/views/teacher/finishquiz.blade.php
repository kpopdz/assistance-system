        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title">Delete the Quiz "{{$quiz->title}}"</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                do you want delete The quiz with title "{{$quiz->title}}"          </div>
 ...
 <div class="card d-flex flex-row">
    ...
    <div class="col p">
           ...
           <div class="d-flex flex-row justify-content-between ">
              ...
              @endif            </div>
      <div>
        <h2 style=" flex-shrink: 0;">{{$quiz->title}}</h2>
                        ...
                        <div class="modal fade" id="disablebackdrop" tabindex="-1" data-bs-backdrop="false">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{route('classes.assigne.end',$quiz->id)}}" method="post">
                                        @csrf
                                        @method('POST')
                                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            <label for="inputDate" class="col-sm-3 col-form-label">Deadline</label>
                            <div class="col-sm-9">
                              <input type="datetime-local" name="dead_line" class="form-control">
                            </div>
                          </div>
