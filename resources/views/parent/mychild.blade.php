              ...
              <tr class="candidates-list">
                ...
                <td>
                  <ul class="list-unstyled mb-0 d-flex justify-content-end">
                    <li><a href="#" class="text-primary" data-toggle="tooltip" title="" data-original-title="view"><a href="{{route('parent.result',$student->user_id)}}" class="btn btn-danger">show result</a>
                  </ul>
                </td>
              </tr>
                                <!-- -->
